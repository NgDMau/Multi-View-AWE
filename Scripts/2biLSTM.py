...
# Now you can use tf.variable_scope as before
with tf.variable_scope('model', reuse=None):
    ...
    class SimpleLSTM(object):
        def __init__(self, is_training, config):
            ...
            # View 1 Layer 2 x1
            input_x1_layer2 = tf.concat([l2r_outputs_layer1_view1, r2l_outputs_layer1_view1], 2, 'concat_layer1_view1_x1')
            ...
            # l2r_outputs_layer2_view1 = tf.cast(l2r_outputs_layer2_view1, tf.int32)
            # print("l2r_outputs_layer2_view1: ", l2r_outputs_layer2_view1)
            l2r_outputs_view1 = tf.gather(tf.reshape(tf.concat(axis=1, values=l2r_outputs_layer2_view1), [-1, hidden_size]),
                                          tf.range(tf.shape(input_x1)[0]) * tf.shape(input_x1)[1] + input_x1_lengths - 1)



            # r2l_outputs_layer2_view1 = tf.cast(r2l_outputs_layer2_view1, tf.int32)
            r2l_outputs_view1 = tf.gather(tf.reshape(tf.concat(axis=1, values=r2l_outputs_layer2_view1), [-1, hidden_size]),
                                          tf.range(tf.shape(input_x1)[0]) * tf.shape(input_x1)[1] + input_x1_lengths - 1)

            self._final_state = x1 = self.normalization(tf.concat([l2r_outputs_view1, ], axis=1, name='concat_view1_x1'))
            ...
            if 2 in obj or 3 in obj:
                ...
                # View 1 Layer 2 x2
                input_x2_layer2 = tf.concat([l2r_outputs_layer1_view1, r2l_outputs_layer1_view1], axis=2, name='concat_layer1_view1_x2')
                ...
                l2r_outputs_view1 = tf.gather(tf.reshape(tf.concat(l2r_outputs_layer2_view1, 1), [-1, hidden_size]),
                                            tf.range(tf.shape(input_x2)[0]) * tf.shape(input_x2)[
                                                1] + input_x2_lengths - 1)
                r2l_outputs_view1 = tf.gather(tf.reshape(tf.concat(r2l_outputs_layer2_view1, 1), [-1, hidden_size]),
                                            tf.range(tf.shape(input_x2)[0]) * tf.shape(input_x2)[
                                                1] + input_x2_lengths - 1)
                x2 = self.normalization(tf.concat([l2r_outputs_view1, r2l_outputs_view1], axis=1, name='concat_view1_x2'))
            ...
            # View 2 Layer 2 c1
            input_c1_layer2 = tf.concat([l2r_outputs_layer1_view2, r2l_outputs_layer1_view2], axis=2, name='concat_layer1_view2_c1')
            ...
            l2r_outputs_view2 = tf.gather(tf.reshape(tf.concat(l2r_outputs_layer2_view2, 1), [-1, hidden_size]),
                                        tf.range(tf.shape(input_c1)[0]) * tf.shape(input_c1)[1] + input_c1_lengths - 1)
            r2l_outputs_view2 = tf.gather(tf.reshape(tf.concat(r2l_outputs_layer2_view2, 1), [-1, hidden_size]),
                                        tf.range(tf.shape(input_c1)[0]) * tf.shape(input_c1)[1] + input_c1_lengths - 1)
            self._word_state = c1 = self.normalization(tf.concat([l2r_outputs_view2, r2l_outputs_view2], 1, 'concat_view2_c1'))
            ...
            if 0 in obj or 1 in obj:
                ...
                # View 2 Layer 2 c2
                input_c2_layer2 = tf.concat([l2r_outputs_layer1_view2, r2l_outputs_layer1_view2], 2, 'concat_layer1_view2_c2')
                ...
                r2l_outputs_view2 = tf.gather(tf.reshape(tf.concat(r2l_outputs_layer2_view2, 1), [-1, hidden_size]),
                                            tf.range(tf.shape(input_c2)[0]) * tf.shape(input_c2)[1] + input_c2_lengths - 1)
                c2 = self.normalization(tf.concat([l2r_outputs_view2, r2l_outputs_view2], 1, 'concat_view2_c2'))
        ...
        def normalization(self, x):
            norm = tf.sqrt(tf.reduce_sum(tf.square(x), axis=1, keepdims=True) + tf.cast(1e-8, dtype=x.dtype))
            return norm
